"""
Modèles SQLAlchemy pour les présences scannées (offline-first).
...
- AttendanceHistory: archive de TOUS les scans bruts reçus
"""
...
class AttendanceHistory(Base):
    """
    Archive brute de tous les scans reçus via synchronisation.
