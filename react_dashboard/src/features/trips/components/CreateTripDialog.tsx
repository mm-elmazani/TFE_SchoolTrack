...
import { Loader2, MapPin, Calendar, School, CheckSquare, Square } from 'lucide-react';
      ...
      <DialogContent className="sm:max-w-[550px] rounded-2xl overflow-hidden p-0 border-0 shadow-2xl">
        ...
        <div className="p-6">
          <DialogHeader className="mb-6">
            <DialogTitle className="text-2xl font-bold text-schooltrack-primary font-heading">Créer un voyage</DialogTitle>
            <DialogDescription className="text-slate-500 font-sans">
              Planifiez une nouvelle sortie et sélectionnez les classes participantes.
            </DialogDescription>
          </DialogHeader>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor="destination" className="text-slate-700 font-bold flex items-center gap-2">
              ...
              <div className="space-y-2">
                <Label htmlFor="date" className="text-slate-700 font-bold flex items-center gap-2">
            ...
            <div className="space-y-2">
              ...
              <div className={cn(
                "border border-slate-200 rounded-2xl p-4 bg-slate-50/50 max-h-[180px] overflow-y-auto space-y-2",
            ...
            <div className="space-y-2">
              <Label htmlFor="description" className="text-slate-700 font-bold">Description (optionnelle)</Label>
              <Textarea 
                id="description" 
                {...register('description')} 
                placeholder="Objectifs, itinéraire, notes..."
